                ...
                <div class="col-md-8">
                    <div class="panel panel-bordered">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="gender" class="col-form-label">Dear</label>&nbsp;
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="date" name="date" placeholder="Date"
                                       value="@if(isset($dataTypeContent->date)){{ $dataTypeContent->date }}@endif">
                            </div>
                            <div class="form-group">
                                <label for="place">place</label>
                                <input type="text" class="form-control" id="place" name="place" placeholder="place"
                                       value="@if(isset($dataTypeContent->place)){{ $dataTypeContent->place }}@endif">
                            </div>
                              <div class="form-group">
                                <label for="postal_code">postal code</label>
                                <input type="text" class="form-control" id="postal_code" name="postal_code" placeholder="postal_code"
                                       value="@if(isset($dataTypeContent->postal_code)){{ $dataTypeContent->postal_code }}@endif">
                            </div>
                            <div class="form-group">
                                <label for="house_number">House number</label>
                                <input type="text" class="form-control" id="house_number" name="house_number" placeholder="House number"
                                       value="@if(isset($dataTypeContent->house_number)){{ $dataTypeContent->house_number }}@endif">
                            </div>
                             <div class="form-group">
